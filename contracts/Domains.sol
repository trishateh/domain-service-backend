...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) ERC721 ("Ape Name Service", "ANS") payable {
    ...
    function register(string calldata name) public payable {
        ...
        // Create the JSON metadata of our NFT. We do this by combining strings & encoding as base64
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Ape name service", "image": "data:image/svg+xml;base64,',
